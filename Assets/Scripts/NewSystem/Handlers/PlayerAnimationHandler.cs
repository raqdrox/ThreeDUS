    ...
    public class PlayerAnimationHandler : MonoBehaviour, IAnimationHandler
    {
        ...
        void AnimHandler()
        {
            ...
            if (_Player._masterSettings.a_runEnable)
                _Player._animator.SetBool(RunningHash, _Player._inputHandler._runInput);
            if (_Player._masterSettings.a_jumpEnable)
                _Player._animator.SetBool(GroundedHash, _Player.isGrounded);
            if (_Player._inputHandler._jumpInput && _Player.isGrounded && _Player._masterSettings.a_jumpEnable)
        ...
        private void BlendHandler()
        {
            ...
            bool runPressed = _Player._masterSettings.a_runEnable ? _Player._inputHandler._runInput : false;
