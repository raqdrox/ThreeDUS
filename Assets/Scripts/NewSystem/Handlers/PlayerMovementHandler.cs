...
namespace FrostyPlayerSystem
{
    public class PlayerMovementHandler : MonoBehaviour, IMovementHandler
    {
        ...
        private bool PlayerJumped => _Player.isGrounded && _Player._inputHandler._jumpInput;
        ...
        private void HorizontalMove()
        {
            ...
            Vector2 movement = _Player._inputHandler._movementAxis;
            float currentSpeed = _Player._inputHandler._runInput ? (movement.y < 0f ? _Player._masterSettings._backrunSpeed : _Player._masterSettings._runSpeed) : (movement.y < 0f ? _Player._masterSettings._backwalkSpeed : _Player._masterSettings._walkSpeed);
